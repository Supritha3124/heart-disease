# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 19:11:36 2022
...
df = pd.read_csv(r'C:\Users\Supritha\Desktop\desktop\project67\heart_data.csv')
print(df.head())

df = df.drop("Unnamed: 0", axis=1)
#A few plots in Seaborn to understand the data

sns.lmplot(x='biking', y='heart_disease', data=df)  
sns.lmplot(x='smoking', y='heart_disease', data=df)  
